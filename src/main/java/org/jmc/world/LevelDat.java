...
public class LevelDat {
	...
	public String getVersion() {
		...
		TAG_Compound data=(TAG_Compound) root.getElement("Version");
		if (data==null) return "unknown";
		TAG_String versionTag = (TAG_String)data.getElement("Name");
		if (versionTag==null) return "unknown";
		return versionTag.value;
	}
	...
	public Dimension getDimension(){
		...
		TAG_Compound player=(TAG_Compound) data.getElement("Player");
		if (player==null) return null;
		TAG_Int dim = (TAG_Int)player.getElement("Dimension");
		if (dim==null) return null;
		return Dimension.getByIndex(dim.value);
	}
