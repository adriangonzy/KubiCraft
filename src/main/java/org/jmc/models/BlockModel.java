...
import org.jmc.config.BlockInfo.Occlusion;
...
public abstract class BlockModel {
	...
	protected void addBox(ChunkProcessor obj, float xs, float ys, float zs, float xe, float ye, float ze,
		...
		if (drawSides == null || drawSides[0]) { // top
			...
			obj.addFace(vertices, null, uvSides == null ? null : uvSides[0], trans, mtlSides[0], false);
		}
		if (drawSides == null || drawSides[1]) { // front
			...
			obj.addFace(vertices, null, uvSides == null ? null : uvSides[1], trans, mtlSides[1], false);
		}
		if (drawSides == null || drawSides[2]) { // back
			...
			obj.addFace(vertices, null, uvSides == null ? null : uvSides[2], trans, mtlSides[2], false);
		}
		if (drawSides == null || drawSides[3]) { // left
			...
			vertices[3] = new Vertex(xs, ye, zs);
			obj.addFace(vertices, null, uvSides == null ? null : uvSides[3], trans, mtlSides[3], false);
		}
		if (drawSides == null || drawSides[4]) { // right
			...
			obj.addFace(vertices, null, uvSides == null ? null : uvSides[4], trans, mtlSides[4], false);
		}
		if (drawSides == null || drawSides[5]) { // bottom
			...
			obj.addFace(vertices, null, uvSides == null ? null : uvSides[5], trans, mtlSides[5], false);
		}
	}
